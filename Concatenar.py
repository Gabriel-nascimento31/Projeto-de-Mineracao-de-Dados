...
caminho_dos_ficheiros = os.path.join(script_dir, '2025/SF_ConsultaRemuneracaoServidoresParlamentares_2025*.csv')
...
output_path = os.path.join(script_dir, '2025/concatenado_2025.csv')
